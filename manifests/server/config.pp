...
class puppet::server::config (
  ...
  $log_access_file       = $::puppet::server_log_access_file,
  $log_file_max_size     = $::puppet::server_log_file_max_size,
  $log_file_max_days     = $::puppet::server_log_file_max_days,
  $log_max_total_size    = $::puppet::server_log_max_total_size,
